...
-- ==================================================================
-- 3B. AUTHENTICATION TABLES (OTP System)
-- ==================================================================
...
-- ==================================================================
-- 5.5. OTP STORAGE TABLE (Authentication)
-- ==================================================================
...
-- Policy: Only service role can manage OTPs (for backend operations)
...
-- 3. OTP Table Access (Service Role Only)
-- Only backend service with service_role key can manage OTPs
CREATE POLICY "Service role can manage OTPs" 
ON public.otps FOR ALL TO service_role USING (true);
