...
const LivestockDetailsScreen = () => {
  ...
  const { profile, loading, saving, updateLivestockDetails } = useUserProfile();
        ...
        <View style={s.headerContent}>
          ...
          <View style={s.headerTextBlock}>
            <View style={s.headerIconBg}>
              <Ionicons name="paw" size={18} color={HEADER_COLOR} />
            </View>
            <View>
              <Text style={s.headerTitle}>{t("livestockDetails.editTitle")}</Text>
              <Text style={s.headerSubtitle}>{t("livestockDetails.editSubtitle")}</Text>
            </View>
          </View>
